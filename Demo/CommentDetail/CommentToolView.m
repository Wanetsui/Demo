...
- (void)layoutUI{
    ...
    _textView = [[PlaceholderTextView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.headImageView.frame)+3,(self.contentBgView.frameHeight-31)/2, self.contentBgView.frameWidth-self.sendBtn.frameWidth-9, MIN_TEXTVIEW_HEIGHT)];
